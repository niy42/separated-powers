...
contract Administrative is Law, IAdministrative {
  ...
  // /**
  //  * checkProposal with or without vote. 
  ...
  //   // (address[] targets, bytes[] memory calldatas, bytes32 descriptionHash, uint256 parentProposalId) =
  //   //         abi.decode(callData, (address[], bytes[], bytes32, uint256));
  //   // parentProposalId can be left at 0 == there is none. this means the chain of proposal is being initiated. 
